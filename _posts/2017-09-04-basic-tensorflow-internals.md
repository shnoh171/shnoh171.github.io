---
layout: post
title: TensorFlow 소개 - 철학, 구조와 내부 동작
categories:
  - TensorFlow
---
**아직 작성 중인 글입니다.**
...
그럼에도 불구하고 TensorFlow는 천하의 Google이 야심차게 진행하고 있는 프로젝트이기 때문에 미래가 밝을 것 같지만, 이를 state-of-the-art라고 단정짓는 것은 매우 위험합니다. 이 사실을 염두에 두고 지금부터 TensorFlow의 철학, 구조와 기본 동작을 알아보도록 하겠습니다.
